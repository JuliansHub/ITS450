...
?><h3>Add Guitar Types</h3>

<form action="add_specific_coffees.php" method="post" accept-charset="utf-8">

	<fieldset><legend>Fill out the form to add guitar type to the site.</legend>
		
		<div class="field"><label for="category"><strong>Guitar Type</strong></label><br />
		...
		<table border="0" width="100%" cellspacing="5" cellpadding="5">
			<thead>
			    ...
			    <th align="right">Electric/Acoustic</th>
			    <th align="right">Capo/Strap</th>
		...
		$grinds = '<option value="ground">Electric</option><option value="whole">Acoustic</option>';
		
		// Need the caffeinated/decaffeinated options:
		$caf_decaf = '<option value="caf">Capo</option><option value="decaf">Strap</option>';
